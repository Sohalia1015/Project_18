...
def save():
    ...
    file_handler = open("C:/Users/Duvashi Family/Downloads/PRO-C118-Student-Boilerplate-Code-main/PRO-C118-Student-Boilerplate-Code-main/static/assets/data_files/data_entry.csv", "a")
